// Flat C exports observed in OneCoreCommonProxyStub.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef ONECORECOMMONPROXYSTUB_C_H
#define ONECORECOMMONPROXYSTUB_C_H
...
#endif
#endif // ONECORECOMMONPROXYSTUB_C_H
