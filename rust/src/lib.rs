//! Windissect-generated Rust FFI bindings for OneCoreCommonProxyStub.dll. Windows only.
#![allow(non_snake_case, non_camel_case_types, dead_code)]

pub mod handles;
pub mod vtables;

pub const EXPECTED_PDB_GUID: &str = "133171A7E5523C043BA98FB7837D5255";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 4154202146;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 27] = [79, 110, 101, 67, 111, 114, 101, 67, 111, 109, 109, 111, 110, 80, 114, 111, 120, 121, 83, 116, 117, 98, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 4154202146 { return 0; }
